/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d3b9618d24466b8fb8593d8c6db3265a)
// Runtime types generated with workerd@1.20260831.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	ARCHITECT_MODEL: "@cf/openai/gpt-oss-120b";
	CF_WEB_ANALYTICS_TOKEN: "";
	ArchitectAgent: DurableObjectNamespace<import("./src/server").ArchitectAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ArchitectAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ARCHITECT_MODEL" | "CF_WEB_ANALYTICS_TOKEN">> {}
}
